     ...
     return(
         ...
         <View style={{backgroundColor:'#12a4d9',flexDirection:'row'}}>
           ...
           <View style={{padding:10}}>
               <TextInput label="Username" style={{height:70,borderWidth:1,margin:10}}></TextInput>
               <TextInput label="Previous Address" style={{height:70,borderWidth:1,margin:10}}></TextInput>
               <TextInput label="Updated Address" style={{height:70,borderWidth:1,margin:10}}></TextInput>
